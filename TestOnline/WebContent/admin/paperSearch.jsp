...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-body" style="margin-left: 5%">
			<br> 
			<a class="layui-btn" style="width: 100%;margin-left:">试卷查询</a>
						...
						<c:forEach items="${paperNames}" var="paper" varStatus="status">
					        <tr>
					            <td>${paper.paperName}</td>
					     		...
					     		<td><a onclick="delPaper('${paper.paperName}')" href="#">删除试卷</a></td>
					        </tr>
					    </c:forEach>
					</tbody>
				</table>
...
<script>
	//删除试卷
	function delPaper(paperName){
		 
		if(!window.confirm("确定删除???")){ return; }
		window.location.href="/TestOnline/delPaper?paperName="+paperName;
	}
	//查看试卷详细信息
