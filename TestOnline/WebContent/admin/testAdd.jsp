...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<br>
			<a class="layui-btn" style="width: 100%; ">学生名单</a>
			<!-- 内容主体区域 -->
	 
			 
				 <table lay-size="lg" lay-even class="layui-table" style="margin-left: 2%">
					<colgroup>
						<col width="34%">
						<col width="33%">
						<col width="33%">
						...
						<c:forEach items="${allstu}" var="student" varStatus="status">
					        <tr>
					            ...
					            <td>${student.stuName}</td>
					     		<td><a href="/TestOnline/testPlan?stuZh=${student.stuZh}">安排考试</td>
					        </tr>
					    </c:forEach>
					</tbody>
				</table>
