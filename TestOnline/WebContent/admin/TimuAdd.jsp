...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-body" style="margin-left: 3%">
			 ...
			 <br>
			 <a class="layui-btn" style="width: 100%;margin-left:">题库添加</a>
			<form class="layui-form"  style="margin-left: 30%; margin-top: 60px" >
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" id="timuId" name="title" required lay-verify="required"
							placeholder="请输入题号" autocomplete="off" class="layui-input"
						 onBlur="checkTimuId()" 
            			 oninput="checkTimuId()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" name="title" id="cont" required lay-verify="required"
							placeholder="请输入题目内容" autocomplete="off" class="layui-input"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" name="title" id="daa" required lay-verify="required"
							placeholder="请输入答案A" autocomplete="off" class="layui-input"
							 onBlur="checkAns()" 
            				 oninput="checkAns()">
					</div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" name="title" id="dab" required lay-verify="required"
							placeholder="请输入答案B" autocomplete="off" class="layui-input"
							  onBlur="checkAns()" 
            				 oninput="checkAns()">
					 </div>
				</div>
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" name="title" id="dac" required lay-verify="required"
							placeholder="请输入答案C" autocomplete="off" class="layui-input" onBlur="checkAns()" 
            				 oninput="checkAns()">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" name="title" id="dad" required lay-verify="required"
							placeholder="请输入答案D" autocomplete="off" class="layui-input" onBlur="checkAns()" 
            				 oninput="checkAns()">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block" style="width: 40%">
						<input type="text" name="title" id="dar" required lay-verify="required"
							placeholder="请输入正确答案" autocomplete="off" class="layui-input"
							 onBlur="checkAns()" 
            				 oninput="checkAns()">
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						...
						<a onclick="checkForm1()" class="layui-btn">添加题目</a>
