...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-body" style="margin-left: 5%">
			<br> 
			<a class="layui-btn" style="width: 100%;margin-left:">考试查询</a>
					...
					<tbody> 
						<c:forEach items="${allTest}" var="test" varStatus="status">
					        <tr>
					            ...
					            <td>${test.endTime}</td>
					       <td><a onclick="changeTime('${test.stuZh}','${test.paperName}')" href="#">修改截止时间 </a></td>
					       <td><a onclick="delTest(${test.stuZh},'${test.paperName}')" href="#">删除考试</a></td>
					        </tr>
					    </c:forEach>
					</tbody>
				</table>
